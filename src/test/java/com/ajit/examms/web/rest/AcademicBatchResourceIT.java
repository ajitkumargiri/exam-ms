...
class AcademicBatchResourceIT {
    ...
    void createAcademicBatch() throws Exception {
        ...
        restAcademicBatchMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(academicBatch)))
    ...
    void putNewAcademicBatch() throws Exception {
        ...
        restAcademicBatchMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAcademicBatch.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedAcademicBatch))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAcademicBatch() throws Exception {
        ...
        restAcademicBatchMockMvc
            .perform(
                put(ENTITY_API_URL_ID, academicBatch.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(academicBatch))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAcademicBatch() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAcademicBatchMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(academicBatch)))
    ...
    void patchNonExistingAcademicBatch() throws Exception {
        ...
        restAcademicBatchMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, academicBatch.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(academicBatch))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAcademicBatch() throws Exception {
        ...
        restAcademicBatchMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(academicBatch))
            )
            .andExpect(status().isMethodNotAllowed());
