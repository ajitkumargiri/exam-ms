...
class ExamApplicationFormResourceIT {
    ...
    void createExamApplicationForm() throws Exception {
        ...
        restExamApplicationFormMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(examApplicationForm))
            )
    ...
    void putNewExamApplicationForm() throws Exception {
        ...
        restExamApplicationFormMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedExamApplicationForm.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedExamApplicationForm))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingExamApplicationForm() throws Exception {
        ...
        restExamApplicationFormMockMvc
            .perform(
                put(ENTITY_API_URL_ID, examApplicationForm.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(examApplicationForm))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamExamApplicationForm() throws Exception {
        ...
        restExamApplicationFormMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(examApplicationForm))
            )
    ...
    void patchNonExistingExamApplicationForm() throws Exception {
        ...
        restExamApplicationFormMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, examApplicationForm.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(examApplicationForm))
            )
            .andExpect(status().isBadRequest());
