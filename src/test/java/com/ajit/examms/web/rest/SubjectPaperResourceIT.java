...
class SubjectPaperResourceIT {
    ...
    void createSubjectPaper() throws Exception {
        ...
        restSubjectPaperMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(subjectPaper)))
    ...
    void putNewSubjectPaper() throws Exception {
        ...
        restSubjectPaperMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedSubjectPaper.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedSubjectPaper))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingSubjectPaper() throws Exception {
        ...
        restSubjectPaperMockMvc
            .perform(
                put(ENTITY_API_URL_ID, subjectPaper.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(subjectPaper))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamSubjectPaper() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restSubjectPaperMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(subjectPaper)))
    ...
    void patchNonExistingSubjectPaper() throws Exception {
        ...
        restSubjectPaperMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, subjectPaper.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(subjectPaper))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamSubjectPaper() throws Exception {
        ...
        restSubjectPaperMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(subjectPaper))
            )
            .andExpect(status().isMethodNotAllowed());
