...
class CollegeResourceIT {
    ...
    void createCollege() throws Exception {
        ...
        // Create the College
        restCollegeMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(college)))
    ...
    void putNewCollege() throws Exception {
        ...
        restCollegeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCollege.getId())
    ...
    void putNonExistingCollege() throws Exception {
        ...
        restCollegeMockMvc
            .perform(
                put(ENTITY_API_URL_ID, college.getId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamCollege() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCollegeMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(college)))
    ...
    void patchNonExistingCollege() throws Exception {
        ...
        restCollegeMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, college.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(college))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCollege() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCollegeMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(college)))
            .andExpect(status().isMethodNotAllowed());
