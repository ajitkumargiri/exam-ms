...
import com.ajit.examms.IntegrationTest;
import com.ajit.examms.domain.Address;
import com.ajit.examms.domain.enumeration.State;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_PO = "AAAAAAAAAA";
    private static final String UPDATED_PO = "BBBBBBBBBB";

    private static final String DEFAULT_PS = "AAAAAAAAAA";
    private static final String UPDATED_PS = "BBBBBBBBBB";

    private static final String DEFAULT_CITY = "AAAAAAAAAA";
    private static final String UPDATED_CITY = "BBBBBBBBBB";

    private static final State DEFAULT_STATE = State.ANDHRA_PRADESH;
    private static final State UPDATED_STATE = State.ARUNACHAL_PRADESH;
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getPo()).isEqualTo(DEFAULT_PO);
        assertThat(testAddress.getPs()).isEqualTo(DEFAULT_PS);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].po").value(hasItem(DEFAULT_PO)))
            .andExpect(jsonPath("$.[*].ps").value(hasItem(DEFAULT_PS)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.po").value(DEFAULT_PO))
            .andExpect(jsonPath("$.ps").value(DEFAULT_PS))
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getPo()).isEqualTo(UPDATED_PO);
        assertThat(testAddress.getPs()).isEqualTo(UPDATED_PS);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.addressLine2(UPDATED_ADDRESS_LINE_2).po(UPDATED_PO).ps(UPDATED_PS).city(UPDATED_CITY).pin(UPDATED_PIN);
