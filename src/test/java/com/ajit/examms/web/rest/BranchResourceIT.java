...
class BranchResourceIT {
    ...
    public static Branch createEntity(EntityManager em) {
        Branch branch = new Branch().name(DEFAULT_NAME).code(DEFAULT_CODE);
        return branch;
    }
    ...
    public static Branch createUpdatedEntity(EntityManager em) {
        Branch branch = new Branch().name(UPDATED_NAME).code(UPDATED_CODE);
        return branch;
    }
    ...
    void putNewBranch() throws Exception {
        ...
        updatedBranch.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void fullUpdateBranchWithPatch() throws Exception {
        ...
        partialUpdatedBranch.name(UPDATED_NAME).code(UPDATED_CODE);
