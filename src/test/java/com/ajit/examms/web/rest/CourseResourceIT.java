...
class CourseResourceIT {
    ...
    private static final String DEFAULT_DETALS = "AAAAAAAAAA";
    private static final String UPDATED_DETALS = "BBBBBBBBBB";
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).code(DEFAULT_CODE).detals(DEFAULT_DETALS);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).code(UPDATED_CODE).detals(UPDATED_DETALS);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getDetals()).isEqualTo(DEFAULT_DETALS);
    }
    ...
    void getAllCourses() throws Exception {
        ...
        restCourseMockMvc
            ...
            .andExpect(jsonPath("$.[*].detals").value(hasItem(DEFAULT_DETALS)));
    }
    ...
    void getCourse() throws Exception {
        ...
        restCourseMockMvc
            ...
            .andExpect(jsonPath("$.detals").value(DEFAULT_DETALS));
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).code(UPDATED_CODE).detals(UPDATED_DETALS);
        ...
        assertThat(testCourse.getDetals()).isEqualTo(UPDATED_DETALS);
    }
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.detals(UPDATED_DETALS);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).code(UPDATED_CODE).detals(UPDATED_DETALS);
