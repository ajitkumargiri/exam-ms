...
class ExamCenterResourceIT {
    ...
    void createExamCenter() throws Exception {
        ...
        restExamCenterMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(examCenter)))
    ...
    void putNewExamCenter() throws Exception {
        ...
        restExamCenterMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedExamCenter.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedExamCenter))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingExamCenter() throws Exception {
        ...
        restExamCenterMockMvc
            .perform(
                put(ENTITY_API_URL_ID, examCenter.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(examCenter))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamExamCenter() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restExamCenterMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(examCenter)))
    ...
    void patchNonExistingExamCenter() throws Exception {
        ...
        restExamCenterMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, examCenter.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(examCenter))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamExamCenter() throws Exception {
        ...
        restExamCenterMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(examCenter))
            )
            .andExpect(status().isMethodNotAllowed());
