package com.ajit.examms.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ajit.examms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ajit.examms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
